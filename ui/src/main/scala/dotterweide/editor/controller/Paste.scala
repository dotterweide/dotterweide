...
private class Paste(document: Document, terminal: Terminal)(implicit p: Platform) extends Action {
  def name: String        = "Paste"
  def mnemonic: Char      = 'P'
  val keys: List[String]  = s"${p.menuModifier} pressed V" :: "shift pressed INSERT" :: Nil
